...
# Healthを持つEntityであれば実行
    execute if data storage csr_score_damage: Damage if entity @s[type=!#scoped_rifle:unhurtable,type=!ender_dragon,nbt={Invulnerable:0b}] run function csr_score_damage:core/attack
