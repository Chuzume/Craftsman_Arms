...
# 下向きに撃つと飛び上がる
    execute if entity @s[predicate=!scoped_rifle:sneak,x_rotation=80..90] run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0f,Duration:6,Age:4,Effects:[{Id:25b,Amplifier:20b,Duration:6,ShowParticles:0b}]}
