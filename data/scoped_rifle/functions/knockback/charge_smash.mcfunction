# 落下速度リセットして打ち上げる
    tp @s @s
    execute if entity @s[type=player] run summon minecraft:area_effect_cloud ~ ~ ~ {Radius:0f,Duration:6,Age:4,Effects:[{Id:25b,Amplifier:12b,Duration:6,ShowParticles:0b}]}
