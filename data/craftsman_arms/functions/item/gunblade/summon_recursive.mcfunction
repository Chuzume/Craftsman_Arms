...
# スライムを召喚
    ...
    summon magma_cube ^ ^-0.5 ^ {NoAI:1b,Silent:1b,Invulnerable:1b,DeathTime:19,DeathLootTable:"minecraft:emptyy",NoAI:1b,Tags:["S.Rif_Slime","Chuz_NonVanillaMob"],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:999,ShowParticles:0b}]}
