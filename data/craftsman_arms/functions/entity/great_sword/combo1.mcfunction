# パーティクル
    execute rotated ~90 ~ positioned ^-0.5 ^ ^2.0 run particle minecraft:dust 0 0.9 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~90 ~ positioned ^-0.5 ^ ^1.8 run particle minecraft:dust 0 0.8 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~90 ~ positioned ^-0.5 ^ ^1.6 run particle minecraft:dust 0 0.7 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~90 ~ positioned ^-0.5 ^ ^1.4 run particle minecraft:dust 0 0.6 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~90 ~ positioned ^-0.5 ^ ^1.2 run particle minecraft:dust 0 0.5 1 1 ~ ~1.4 ~ 0 0 0 1 1

#
   # execute rotated ~90 ~ positioned ^-0.7 ^ ^2.0 run particle minecraft:dust 1 0.9 1 1 ~ ~1.4 ~ 0 0 0 1 1
   # execute rotated ~90 ~ positioned ^-0.7 ^ ^1.8 run particle minecraft:dust 1 0.8 1 1 ~ ~1.4 ~ 0 0 0 1 1
   # execute rotated ~90 ~ positioned ^-0.7 ^ ^1.6 run particle minecraft:dust 1 0.7 1 1 ~ ~1.4 ~ 0 0 0 1 1
   # execute rotated ~90 ~ positioned ^-0.7 ^ ^1.4 run particle minecraft:dust 1 0.6 1 1 ~ ~1.4 ~ 0 0 0 1 1
   # execute rotated ~90 ~ positioned ^-0.7 ^ ^1.2 run particle minecraft:dust 1 0.5 1 1 ~ ~1.4 ~ 0 0 0 1 1
...
# 進んだ距離
    ...
    tag @s[scores={S.Rif_RotDistance=..-250}] add S.Rif_Kill
