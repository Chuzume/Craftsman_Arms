# パーティクル
    execute rotated ~-90 ~ positioned ^-0.5 ^ ^2.0 run particle minecraft:dust 0.5 0.9 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~-90 ~ positioned ^-0.5 ^ ^1.8 run particle minecraft:dust 0.5 0.8 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~-90 ~ positioned ^-0.5 ^ ^1.6 run particle minecraft:dust 0.5 0.7 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~-90 ~ positioned ^-0.5 ^ ^1.4 run particle minecraft:dust 0.5 0.6 1 1 ~ ~1.4 ~ 0 0 0 1 1
    execute rotated ~-90 ~ positioned ^-0.5 ^ ^1.2 run particle minecraft:dust 0.5 0.5 1 1 ~ ~1.4 ~ 0 0 0 1 1
