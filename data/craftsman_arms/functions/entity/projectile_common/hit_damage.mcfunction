...
# ヘッドショットチェック
    execute anchored eyes positioned ^ ^ ^ positioned ~-0.5 ~-0.5 ~-0.5 if entity @e[type=armor_stand,tag=S.Rif_Projectile,dx=0] run function craftsman_arms:entity/projectile_common/hit_headshot
